"""Agent Studio sidebar tab UI composition and widget wiring."""
...
def compose_agent_studio_tab() -> Iterator[Any]:
    """Yield the Agent tab pane with Profile/Tools/Team subviews."""
    with TabPane("Agent", id="tab_agent"):
        with Vertical(id="agent_panel"):
            with Horizontal(id="agent_view_switch"):
                yield Button("Profile", id="agent_view_profile", compact=True, variant="primary")
...
def wire_agent_studio_widgets(app: Any) -> None:
    """Bind Agent Studio tab widgets onto app fields used by event handlers."""
...
__all__ = ["compose_agent_studio_tab", "wire_agent_studio_widgets"]
