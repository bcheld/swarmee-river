...
def wire_engage_widgets(app: Any) -> None:
    ...
    app._engage_plan_scroll = app.query_one("#engage_plan_scroll", VerticalScroll)
    app._engage_plan_summary_scroll = app._engage_plan_scroll
    app._engage_plan_summary = app.query_one("#engage_plan_summary", Static)
    app._engage_plan_questions = app.query_one("#engage_plan_questions", Vertical)
    app._engage_plan_items = app.query_one("#engage_plan_items", Vertical)
