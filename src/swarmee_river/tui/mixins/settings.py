...
class SettingsMixin:
    ...
    _DIAGNOSTICS_DEFAULTS: dict[str, str] = {
        ...
        "SWARMEE_DIAG_RETENTION_DAYS": "7",
        "SWARMEE_DIAG_MAX_BYTES": "52428800",
    }
    ...
    def _apply_bedrock_runtime_settings(self) -> None:
        ...
        self._write_transcript_line(
            "[settings] bedrock runtime updated "
            f"(read={read_timeout}s connect={connect_timeout}s retries={max_retries})."
        )
